    ...
    <>
      <label className="w-full relative" htmlFor={id}>
        <input
          ...
          } rounded-sm w-full py-3 px-2.5 tablet:px-3 text-black-charcoal text-base placeholder:text-black-charcoal placeholder:text-base bg-yellow h-12 focus:outline-none focus:border-accent focus:border-[3px]`}
          id={id}
          type="text"
